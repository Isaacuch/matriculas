		...
		<div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <select name="sede" class="form-control" id="sede" required="" value="">
		    	...
		    	<option value="Primero" <?= $row['sede']=='Concepción, Alajuelita'? 'selected':'' ?>>Concepción, Alajuelita</option>
		    	<option value="Segundo" <?= $row['sede']=='25 de Julio, Hatillo'? 'selected':'' ?>>25 de Julio, Hatillo</option>
		    	<option value="Tercero" <?= $row['sede']=='Linda Vista, Patarrá'? 'selected':'' ?>>Linda Vista, Patarrá</option>
		    </select>
	  	</div>
